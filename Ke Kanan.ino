#define LED1 4 //deklarasi pin led1 dengan #define
int LED2 = 3; //deklarasi pin led2 dengan tipe data nama variabel
const int LED3 = 2; //deklarasi pin led3 dengan constanta tipe data dan nama variabel agar nilai variabelnya tidak bisa diubah-ubah
